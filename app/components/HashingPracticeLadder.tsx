...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    pattern: "Set existence",
    level: "warm-up",
    leetcodeId: 2351,
    leetcodeSlug: "first-letter-to-appear-twice",
  },
  {
    num: 3,
    name: "Longest Substring with At Most K Distinct",
    pattern: "counts map + window",
    level: "core",
    leetcodeId: 340,
  ...
  },
  {
    ...
    level: "core",
    leetcodeId: 2248,
    leetcodeSlug: "intersection-of-multiple-arrays",
  },
  {
    num: 5,
    name: "Subarray Sum Equals K",
    pattern: "Prefix + freq map",
    level: "intermediate",
    leetcodeId: 560,
  ...
  },
  {
    ...
    note: "Rows/columns as immutable tuple or string keys.",
  },
];
...
export default function HashingPracticeLadder() {
  return (
