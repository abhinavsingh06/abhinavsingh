...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    level: "intermediate",
    leetcodeId: 24,
    leetcodeSlug: "swap-nodes-in-pairs",
  },
  {
    num: 6,
    name: "Reverse Linked List II",
    pattern: "Partial reverse",
    level: "intermediate",
    leetcodeId: 92,
  ...
  },
  {
    ...
    note: "Compose middle + reverse + weave — classic multi-pattern.",
  },
];
...
export default function LinkedListPracticeLadder() {
  return (
