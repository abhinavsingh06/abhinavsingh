...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    level: "warm-up",
    leetcodeId: 1047,
    leetcodeSlug: "remove-all-adjacent-duplicates-in-string",
  },
  {
    num: 3,
  ...
  {
    num: 8,
    name: "Longest Continuous Subarray (Limit)",
    pattern: "Two mono deques",
    level: "hard",
    leetcodeId: 1438,
    leetcodeSlug: "longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit",
    note: "Sliding window + min deque + max deque.",
  },
];
...
export default function StackQueuePracticeLadder() {
  return (
    <div className="my-8 overflow-hidden rounded-xl border border-[var(--line)] bg-[var(--bg-2)]">
      <div className="border-b border-[var(--line)] px-5 py-4 sm:px-6">
        ...
        <p className="mt-1 text-sm text-[var(--fg-2)]">
          Step through the animations first, then open any problem on LeetCode.
        </p>
      </div>
