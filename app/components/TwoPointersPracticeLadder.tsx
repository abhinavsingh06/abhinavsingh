...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    pattern: "Parallel scan · merge",
    level: "core",
    leetcodeId: 88,
    leetcodeSlug: "merge-sorted-array",
    note: "Fill from the back to merge in-place without extra space.",
  },
  {
    num: 5,
    name: "Remove Duplicates from Sorted Array",
    pattern: "Same-array chase",
    level: "intermediate",
    leetcodeId: 26,
  ...
  },
  {
    num: 7,
    name: "3Sum",
    pattern: "Sort + fixed i + two pointers",
    level: "hard",
    leetcodeId: 15,
    leetcodeSlug: "3sum",
  },
  {
    ...
    pattern: "Opposite ends · max height",
    level: "hard",
    leetcodeId: 42,
...
export default function TwoPointersPracticeLadder() {
  return (
